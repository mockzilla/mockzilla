...
// Examples:
//
//	X-Mockzilla-Replay: data.name,data.address.zip
//	X-Mockzilla-Replay: body:biller,reference;query:channel
const headerReplayMatch = "X-Mockzilla-Replay"
...
// Headers are the response headers (excluding internal X-Mockzilla-* headers).
...
// parseReplayHeader parses the X-Mockzilla-Replay header value into a ReplayMatch.
